...
<div class="full">
	<a name="calendar"></a>
	<h3>View Schedule</h3>
	<p class="info">From this form, you can add and edit shifts for any given user. Changes made via this form are filed as <i>forgot to clock it</i> notices, and will not be reflected here until <i><strong>after</strong></i> the evening maintence task runs.
	<br />
...
<? // Ajax bPopup Box for validation stuff; ?>
	...
	<div id="event_edit_container"> 
		<?php $form=$this->beginWidget('CActiveForm', array(
			...
			<p class="info">This will file a forgot report for this shift. Changes made will not be reflected here until after the evening maintence task runs.</p>
